...
def plot_cumulative_return(backtest_df: pd.DataFrame, save_plots = False) -> None:
...
def plot_drawdown(backtest_df: pd.DataFrame, save_plots = False) -> None:
...
def run_plots3(df: pd.DataFrame, save_plots = False) -> None:
    plot_cumulative_return(df, save_plots)
    plot_drawdown(df, save_plots)
